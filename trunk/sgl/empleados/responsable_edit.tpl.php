...
<div id="formControls">
    ...
    <p class="create">
        <a href="<?php _p(__VIRTUAL_DIRECTORY__ . __FORM_EMPLEADO__) ?>/empleado_edit.php"><?php _t('Crear un nuevo'); ?> <?php _t('Empleado'); ?></a>
    </p>
    
    <?php $this->lstLICENCIAIdLICENCIAObject->RenderWithName(); ?>
    <p class="create">
	<a href="<?php _p(__VIRTUAL_DIRECTORY__ . __FORM_EMPLEADO__) ?>/licencia_edit.php"><?php _t('Crear una nueva'); ?> <?php _t('Licencia');?></a>
    </p>
