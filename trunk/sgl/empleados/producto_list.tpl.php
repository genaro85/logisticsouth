<?php
	...
	$strPageTitle = QApplication::Translate('Productos') . ' - ' . QApplication::Translate('List All');
...
?>
	...
	<div id="titleBar">
		...
		<h1><?php _t('Productos'); ?></h1>
	</div>

	<?php $this->dtgProductos->Render(); ?>

	<p class="create">
		<a href="<?php _p(__VIRTUAL_DIRECTORY__ . __FORM_EMPLEADO__) ?>/producto_edit.php"><?php _t('Create a New'); ?> <?php _t('Producto');?></a>
	</p>
