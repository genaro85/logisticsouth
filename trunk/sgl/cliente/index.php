...
<div id="bodymiddlePan" align="justify">
    ...
    <p class="lasttext">Clickee <a href="<?php _p(__VIRTUAL_DIRECTORY__ . __FORM_CLIENTE__) ?>/seg_licencia_list.php">aquí</a> para poder ver el seguimiento de sus licencias</p>
</div>
