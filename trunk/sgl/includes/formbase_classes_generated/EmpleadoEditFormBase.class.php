<?php
	 ...
	 */
	abstract class EmpleadoEditFormBase extends QForm {
		// Local instance of the EmpleadoMetaControl
		/**
		 * @var EmpleadoMetaControlGen mctEmpleado
		 */
...
//		protected function Form_PreRender() {}
		...
		protected function Form_Create() {
			...
			// Use the CreateFromPathInfo shortcut (this can also be done manually using the EmpleadoMetaControl constructor)
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctEmpleado = EmpleadoMetaControl::CreateFromPathInfo($this);
			...
			$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(QApplication::Translate('Are you SURE you want to DELETE this') . ' ' . QApplication::Translate('Empleado') . '?'));
