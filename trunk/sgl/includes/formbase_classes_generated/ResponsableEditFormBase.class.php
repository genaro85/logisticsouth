<?php
	 ...
	 */
	abstract class ResponsableEditFormBase extends QForm {
		// Local instance of the ResponsableMetaControl
		/**
		 * @var ResponsableMetaControlGen mctResponsable
		 */
...
//		protected function Form_PreRender() {}
		...
		protected function Form_Create() {
			...
			$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(QApplication::Translate('Are you SURE you want to DELETE this') . ' ' . QApplication::Translate('Responsable') . '?'));
