...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    ...
    <body>
        ...
        <ul class="menu">
            ...
            <li class="top"><a href="<?php _p(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__) ?>/Licencia.php" target="_self" class="top_link"><span>Licencias</span></a>
                <ul class="sub">
                    <li><a href="<?php _p(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__) ?>/licencia_list.php" target="_self">Licencia</a></li>
                    ...
                    <li><a href="<?php _p(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__) ?>/fase_licencia_list.php" target="_self">Fase Licencia</a></li>
                    ...
                    <li><a href="<?php _p(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__) ?>/importacion_list.php" target="_self">Importacion</a></li>
            ...
            <li class="top"><a href="<?php _p(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__) ?>/Proveedor.php" target="_self" class="top_link"><span>Proveedores</span></a>
                <ul class="sub">
                    ...
                    <li><a href="<?php _p(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__) ?>/pais_list.php" target="_self">Pais</a></li>
                </ul>
            </li>
        </ul>
        <div id="content">
