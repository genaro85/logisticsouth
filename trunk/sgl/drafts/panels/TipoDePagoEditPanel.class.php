<?php
	...
	class TipoDePagoEditPanel extends QPanel {
		...
		public function __construct($objParentObject, $strClosePanelMethod, $intIdTIPODEPAGO = null, $strControlId = null) {
			// Call the Parent
			try {
			...
			$this->strTemplate = __DOCROOT__ . __PANEL_DRAFTS__ . '/TipoDePagoEditPanel.tpl.php';
			$this->strClosePanelMethod = $strClosePanelMethod;

			// Construct the TipoDePagoMetaControl
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctTipoDePago = TipoDePagoMetaControl::Create($this, $intIdTIPODEPAGO);
			...
			$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'),  QApplication::Translate('TipoDePago'))));
