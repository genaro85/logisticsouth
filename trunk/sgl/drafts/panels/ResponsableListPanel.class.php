<?php
	 ...
	 * list a collection of Responsable objects.  It includes
	 * functionality to perform pagination and sorting on columns.
	 *
	 * To take advantage of some (or all) of these control objects, you
	 * must create a new QPanel which extends this ResponsableListPanelBase
	 * class.
	 *
	 ...
	 * 
	 */
	class ResponsableListPanel extends QPanel {
		// Local instance of the Meta DataGrid to list Responsables
		/**
		 * @var ResponsableDataGrid
		 */
		public $dtgResponsables;
		...
		public function __construct($objParentObject, $strSetEditPanelMethod, $strCloseEditPanelMethod, $strControlId = null) {
			...
			// Setup the Template
			$this->Template = __DOCROOT__ . __PANEL_DRAFTS__ . '/ResponsableListPanel.tpl.php';
			...
			$this->dtgResponsables->ItemsPerPage = 8;
			...
			$this->dtgResponsables->MetaAddEditProxyColumn($this->pxyEdit, 'Edit', 'Edit');
			...
			$this->btnCreateNew->Text = QApplication::Translate('Create a New') . ' ' . QApplication::Translate('Responsable');
			$this->btnCreateNew->AddAction(new QClickEvent(), new QAjaxControlAction($this, 'btnCreateNew_Click'));
		}

		public function pxyEdit_Click($strFormId, $strControlId, $strParameter) {
			$strParameterArray = explode(',', $strParameter);
			$objEditPanel = new ResponsableEditPanel($this, $this->strCloseEditPanelMethod, $strParameterArray[0], $strParameterArray[1]);
		...
		public function btnCreateNew_Click($strFormId, $strControlId, $strParameter) {
			$objEditPanel = new ResponsableEditPanel($this, $this->strCloseEditPanelMethod, null);
			$strMethodName = $this->strSetEditPanelMethod;
			$this->objForm->$strMethodName($objEditPanel);
		}
	}
