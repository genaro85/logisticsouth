<?php
	...
	require(__FORMBASE_CLASSES__ . '/EtapaEditFormBase.class.php');
	 ...
	 * @subpackage Drafts
	 */
	class EtapaEditForm extends EtapaEditFormBase {
...
//		protected function Form_Create() {}
	...
	// etapa_edit.tpl.php as the included HTML template file
	EtapaEditForm::Run('EtapaEditForm');
?>