<?php
	...
	require(__FORMBASE_CLASSES__ . '/ListaDeDocumentoEditFormBase.class.php');
	 ...
	 * @subpackage Drafts
	 */
	class ListaDeDocumentoEditForm extends ListaDeDocumentoEditFormBase {
...
//		protected function Form_Create() {}
	...
	// lista_de_documento_edit.tpl.php as the included HTML template file
	ListaDeDocumentoEditForm::Run('ListaDeDocumentoEditForm');
?>