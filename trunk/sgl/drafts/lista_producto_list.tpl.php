<?php
	...
	$strPageTitle = QApplication::Translate('Productos de la Licencia') . ' - ' . QApplication::Translate('List All');
...
?>
	...
	<div id="titleBar">
		...
		<h1><?php _t('Productos de la Licencia'); ?></h1>
	</div>

	<?php $this->dtgListaProductos->Render(); ?>

	<p class="create">
		<a href="<?php _p(__VIRTUAL_DIRECTORY__ . __FORM_ADMINISTRADOR__) ?>/lista_producto_edit.php"><?php _t('Create a New'); ?> <?php _t('ListaProducto');?></a>
	</p>
