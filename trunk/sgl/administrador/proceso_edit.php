...
//		protected function Form_Create() {}
    ...
    protected function RedirectToListPage() {
        QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_ADMINISTRADOR__ . '/proceso_list.php');
    }

    protected function btnSave_Click($strFormId, $strControlId, $strParameter) {
        // Delegate "Save" processing to the ProcesoMetaControl
        $this->mctProceso->SaveProceso();
        $this->RedirectToFasePage();
    }

    protected function RedirectToFasePage() {
        QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_ADMINISTRADOR__ . '/fase_edit.php');
    }
