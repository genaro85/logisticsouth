<?php
	...
	$strPageTitle = QApplication::Translate('Proveedores') . ' - ' . QApplication::Translate('List All');
...
?>
	...
	<div id="titleBar">
		...
		<h1><?php _t('Proveedores'); ?></h1>
	</div>

	<?php $this->dtgProveedors->Render(); ?>

	<p class="create">
		<a href="<?php _p(__VIRTUAL_DIRECTORY__ . __FORM_ADMINISTRADOR__) ?>/proveedor_edit.php"><?php _t('Crear un Nuevo'); ?> <?php _t('Proveedor');?></a>
	</p>
