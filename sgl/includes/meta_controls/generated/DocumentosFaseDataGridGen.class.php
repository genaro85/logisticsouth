<?php
	 ...
	 * listing a collection of DocumentosFase objects.  It includes
	 ...
	 * 
	 */
	class DocumentosFaseDataGridGen extends QDataGrid {
		 ...
		 * way of adding a column to this DocumentosFase datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the DocumentosFase object, or it can be any QQNode extending from QQN::DocumentosFase().
		 * 
		 ...
		 * sorting using two fields from the DocumentosFase object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from DocumentosFase
		...
		public function MetaDataBinder() {
			...
			if ($this->Paginator) {
				$this->TotalItemCount = DocumentosFase::QueryCount($objConditions);
			}
			...
			// Set the DataSource to be a Query result from DocumentosFase, given the clauses above
			$this->DataSource = DocumentosFase::QueryArray($objConditions, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a DocumentosFase-based QQNode.
		 * It will also verify that it is a proper DocumentosFase-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'DOCUMENTOS_FASE') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "DOCUMENTOS_FASE".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'DOCUMENTOIdDOCUMENTO': return QQN::DocumentosFase()->DOCUMENTOIdDOCUMENTO;
				case 'DOCUMENTOIdDOCUMENTOObject': return QQN::DocumentosFase()->DOCUMENTOIdDOCUMENTOObject;
				case 'FASEIdFASE': return QQN::DocumentosFase()->FASEIdFASE;
				case 'FASEIdFASEObject': return QQN::DocumentosFase()->FASEIdFASEObject;
				default: throw new QCallerException('Simple Property not found in DocumentosFaseDataGrid content: ' . $mixContent);
