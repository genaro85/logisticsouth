<?php
	 ...
	 * listing a collection of VigenciaDocumento objects.  It includes
	 ...
	 * 
	 */
	class VigenciaDocumentoDataGridGen extends QDataGrid {
		 ...
		 * way of adding a column to this VigenciaDocumento datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the VigenciaDocumento object, or it can be any QQNode extending from QQN::VigenciaDocumento().
		 * 
		 ...
		 * sorting using two fields from the VigenciaDocumento object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from VigenciaDocumento
		...
		public function MetaDataBinder() {
			...
			if ($this->Paginator) {
				$this->TotalItemCount = VigenciaDocumento::QueryCount($objConditions);
			}
			...
			// Set the DataSource to be a Query result from VigenciaDocumento, given the clauses above
			$this->DataSource = VigenciaDocumento::QueryArray($objConditions, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a VigenciaDocumento-based QQNode.
		 * It will also verify that it is a proper VigenciaDocumento-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'VIGENCIA_DOCUMENTO') {
