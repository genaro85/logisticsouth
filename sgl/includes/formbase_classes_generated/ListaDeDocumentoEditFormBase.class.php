<?php
	 ...
	 */
	abstract class ListaDeDocumentoEditFormBase extends QForm {
		// Local instance of the ListaDeDocumentoMetaControl
		/**
		 * @var ListaDeDocumentoMetaControlGen mctListaDeDocumento
		 */
...
//		protected function Form_PreRender() {}
		...
		protected function Form_Create() {
			...
			// Use the CreateFromPathInfo shortcut (this can also be done manually using the ListaDeDocumentoMetaControl constructor)
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctListaDeDocumento = ListaDeDocumentoMetaControl::CreateFromPathInfo($this);
			...
			$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(QApplication::Translate('Are you SURE you want to DELETE this') . ' ' . QApplication::Translate('ListaDeDocumento') . '?'));
		...
		protected function RedirectToListPage() {
			QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__ . '/lista_de_documento_list.php');
		}
	}
?>
