<?php
	 ...
	 */
	abstract class ProductoEditFormBase extends QForm {
		// Local instance of the ProductoMetaControl
		/**
		 * @var ProductoMetaControlGen mctProducto
		 */
...
//		protected function Form_PreRender() {}
		...
		protected function Form_Create() {
			...
			$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(QApplication::Translate('Are you SURE you want to DELETE this') . ' ' . QApplication::Translate('Producto') . '?'));
