<?php
	 ...
	 */
	abstract class TransporteEditFormBase extends QForm {
		// Local instance of the TransporteMetaControl
		/**
		 * @var TransporteMetaControlGen mctTransporte
		 */
...
//		protected function Form_PreRender() {}
		...
		protected function Form_Create() {
			...
			// Use the CreateFromPathInfo shortcut (this can also be done manually using the TransporteMetaControl constructor)
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctTransporte = TransporteMetaControl::CreateFromPathInfo($this);
			...
			$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(QApplication::Translate('Are you SURE you want to DELETE this') . ' ' . QApplication::Translate('Transporte') . '?'));
