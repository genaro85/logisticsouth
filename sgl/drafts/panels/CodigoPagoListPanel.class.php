<?php
	 ...
	 * list a collection of CodigoPago objects.  It includes
	 * functionality to perform pagination and sorting on columns.
	 *
	 * To take advantage of some (or all) of these control objects, you
	 * must create a new QPanel which extends this CodigoPagoListPanelBase
	 * class.
	 *
	 ...
	 * 
	 */
	class CodigoPagoListPanel extends QPanel {
		// Local instance of the Meta DataGrid to list CodigoPagos
		/**
		 * @var CodigoPagoDataGrid
		 */
		public $dtgCodigoPagos;
		...
		public function __construct($objParentObject, $strSetEditPanelMethod, $strCloseEditPanelMethod, $strControlId = null) {
			...
			// Setup the Template
			$this->Template = __DOCROOT__ . __PANEL_DRAFTS__ . '/CodigoPagoListPanel.tpl.php';
			...
			$this->dtgCodigoPagos->ItemsPerPage = 8;
			...
			$this->dtgCodigoPagos->MetaAddEditProxyColumn($this->pxyEdit, 'Edit', 'Edit');
			...
			$this->btnCreateNew->Text = QApplication::Translate('Create a New') . ' ' . QApplication::Translate('CodigoPago');
			$this->btnCreateNew->AddAction(new QClickEvent(), new QAjaxControlAction($this, 'btnCreateNew_Click'));
		}

		public function pxyEdit_Click($strFormId, $strControlId, $strParameter) {
			$strParameterArray = explode(',', $strParameter);
			$objEditPanel = new CodigoPagoEditPanel($this, $this->strCloseEditPanelMethod, $strParameterArray[0], $strParameterArray[1]);
		...
		public function btnCreateNew_Click($strFormId, $strControlId, $strParameter) {
			$objEditPanel = new CodigoPagoEditPanel($this, $this->strCloseEditPanelMethod, null);
			$strMethodName = $this->strSetEditPanelMethod;
			$this->objForm->$strMethodName($objEditPanel);
		}
	}
