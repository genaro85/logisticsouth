...
//		protected function Form_Load() {}
    ...
    protected function Form_Validate() {
        ...
        if ($this->calFechaInicio->DateTime > $this->calFechaFin->DateTime) {
            $this->calFechaFin->Warning = "La fecha de fin debe ser posterior a la fecha de inicio";
            return false;
        }
    ...
    protected function RedirectToListPage() {
        QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_EMPLEADO__ . '/responsable_list.php');
    }
