<?php
	// This is the HTML template include file (.tpl.php) for the administrador_list.php
...
?>
	...
	<p class="create">
		<a href="<?php _p(__VIRTUAL_DIRECTORY__ . __FORM_EMPLEADO__) ?>/administrador_edit.php"><?php _t('Create a New'); ?> <?php _t('Administrador');?></a>
	</p>
